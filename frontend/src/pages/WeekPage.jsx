        ...
        <div style={{ marginTop: 10, paddingTop: 10, borderTop: '1px solid var(--border)', display: 'flex', flexDirection: 'column', gap: 5 }}>
          {finished.map(e => (
            <div key={e.id} style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              ...
              {e.source === 1 && <span className="tag tag-m" style={{ width: 46, justifyContent: 'center', flexShrink: 0, whiteSpace: 'nowrap' }}>manuell</span>}{e.source === 2 && <span className="tag" style={{ background: "rgba(255,170,0,.12)", color: "#ffaa00", width: 46, justifyContent: 'center', flexShrink: 0, whiteSpace: 'nowrap' }}>E-Mail</span>}
